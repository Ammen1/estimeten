    ...
    >
      <div className="container relative" ref={parallaxRef}>
        ...
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          Discover the Innovation in Diabetes Management with {` `}
        ...
        <p className="max-w-3xl mx-auto mb-6 body-1 text-n-2 lg:mb-8">
          Diabetes Mellitus requires careful management of blood glucose levels (BGLs) to avoid complications. 
          Many patients struggle to control BGLs despite diet and exercise. Proper insulin dosage is crucial. 
          </p>
